...
class ConvLSTM(nn.Module):
    ...
    def __init__(self, input_dim, output_dim, hidden_dim, kernel_size, num_layers,
        ...
        self.final_conv = nn.Conv2d(self.hidden_dim[-1], output_dim, kernel_size=1)
    ...
    def forward(self, input_tensor, hidden_state=None):
        ...
        # We want to predict the next frame, so we take the last hidden state
        last_hidden_state = last_layer_output[:, -1, :, :, :]
        
        # Apply final conv to get the right number of output channels
