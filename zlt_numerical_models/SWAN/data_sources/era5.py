...
def era5_request(data_vars: List[str], grid: Grid, data_date: date, out_name, data_options: DataOptions):
    ...
    request_coords = [40.52, -30.62, 36.52, -26.62]
    if grid:
        # TODO account for coordinates sign
        request_coords = [grid.max_y * 1.05, grid.min_x * 1.05, grid.min_y * 0.95, grid.max_x * 0.95]

    # TODO add coords intersection check
    # TODO add integration step
